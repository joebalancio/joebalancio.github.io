...
var responsiveNav = function(window, document) {
    ...
    var nav, opts, navToggle, docEl = document.documentElement, head = document.getElementsByTagName("head")[0], styleElement = document.createElement("style"), navOpen = false, addEvent = function(el, evt, fn, bubble) {
    ...
    ResponsiveNav.prototype = {
        ...
        _calcHeight: function() {
            var savedHeight = nav.inner.offsetHeight, innerStyles = "#" + this.wrapperEl + ".opened{max-height:" + savedHeight + "px}";
            if (computed) {
